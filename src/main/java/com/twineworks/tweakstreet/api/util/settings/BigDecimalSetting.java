...
public final class BigDecimalSetting implements ValueProvider {
  ...
  public final static class Builder {
    ...
    public BigDecimalSetting build(){
      return new BigDecimalSetting(name, valueProvider, nullable);
    }
  ...
  private BigDecimal lastRet;

  private BigDecimalSetting(String name, ValueProvider valueProvider, boolean nullable) {
  ...
  public BigDecimal get(){
    ...
    BigDecimal num;
    if (nullable){
      num = Utils.asBigDecimal(name, value);
      if (num == null){
        lastRet = null;
        lastRetSet = true;
        return null;
      ...
      num = Utils.asNNBigDecimal(name, value);
    }
