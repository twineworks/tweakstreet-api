...
public final class DoubleSetting implements ValueProvider {
  ...
  public final static class Builder {
    ...
    public DoubleSetting build(){
      return new DoubleSetting(name, valueProvider, nullable);
    }
  ...
  private DoubleSetting(String name, ValueProvider valueProvider, boolean nullable) {
  ...
  public Double get(){
    ...
    if (nullable){
      ...
      num = Utils.asNNDouble(name, value);
    }
